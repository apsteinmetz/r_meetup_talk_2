...
## I Write About Data Science at [outsiderdata.net](https://outsiderdata.netlify.app/)
...
-   Divide posts into 3 month samples.

-   Test for significant posters in the window.

-   During the 1 month following out of sample, follow sentiment from positive alpha poster, and do the opposite from a negative alpha poster.

-   Reverse the trade 7 days later.
...
This Deck Was Built With Quarto by Posit. Source Here:

-   {{< fa brands github size=1xl >}} `https://github.com/apsteinmetz/r_meetup_talk_2`

Connect With Me:

-   {{< fa brands bluesky size=1xl >}} {{< fa brands mastodon size=1xl >}} `@adababbage`
