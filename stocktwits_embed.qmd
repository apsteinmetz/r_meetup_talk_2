...
-   Refer to the my GitHub repository for all the analytic code and details.
...
- Other packages are available, e.g. `quantmod`, `tidyquant`, `yfR`.
- Some tickers don't have valid prices histories aligned with our sentiment data. Ignore.

## Build Track Records

## Find Statistically Significant Track Records

## Construct Sample and Out-Of-Sample Windows

## Develop Trading Strategy

## Develop Realistic Retail Strategy
...
-   Transaction costs ignored (but small for retail investors today).
-   Execution Slippage ignored (but small for highly liquid stocks).
-   Yahoo Finance data quality issues (but manageable).
-   We use a 7-day window but who knows what the poster horizon is?
